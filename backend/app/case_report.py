...
def _render_pdf(pdf_path, meta: dict, prepared: list[dict]) -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        author="CCTV Forensic Investigation Platform",
    ...
    # ---------------- cover ----------------
    st.append(Paragraph("CCTV Evidence Report", s["RTitle"]))
    ...
    st.append(_kv_table([
        ...
        ("Generated by", "CCTV Forensic Investigation Platform (automated)"),
